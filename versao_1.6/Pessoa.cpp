...
void Pessoa::setDepartamento(Departamento * deptoname){
	DepartamentoFiliado = deptoname;
}
...
void Pessoa::qualDepartamentoTrabalha(){
		cout << nome << " trabalha para o departamento "<<  DepartamentoFiliado->getName() << endl;
}